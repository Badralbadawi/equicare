			...
			<div class="box-header">
				...
				<div class="box-body ">
					...
					<form class="form" method="post" action="<?php echo e(route('hospitals.store')); ?>">
						...
						<div class="form-group col-md-6">
							<label for="Attachment_id"> <?php echo app('translator')->get('equicare.Attachment'); ?> </label>
								...
								<?php if(isset($hospitals)): ?>
									<?php $__currentLoopData = $hospitals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hospital): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($hospital->id); ?>"
											<?php echo e(old('Attachment_id')?'selected':''); ?>
						...
						<div class="form-group col-md-6">
							<label for="Directorates_id"> <?php echo app('translator')->get('equicare.Directorates'); ?> </label>
							<select name="Directorates_id" class="form-control">
								<option value="">---select---</option>
								<?php if(isset($hospitals)): ?>
									<?php $__currentLoopData = $hospitals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hospital): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($hospital->id); ?>"
											<?php echo e(old('Directorates_id')?'selected':''); ?>
						...
						<div class="form-group col-md-6">
							<label for="Governorate_id"> <?php echo app('translator')->get('equicare.Governorate'); ?> </label>
							<select name="Governorate_id" class="form-control">
								<option value="">---select---</option>
								<?php if(isset($hospitals)): ?>
									<?php $__currentLoopData = $hospitals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hospital): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($hospital->id); ?>"
											<?php echo e(old('Governorate_id')?'selected':''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\equicare - mains\framework\resources\views/hospitals/create.blade.php ENDPATH**/ ?>