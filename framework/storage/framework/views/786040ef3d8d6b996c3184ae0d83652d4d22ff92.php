...
<?php $__env->startSection('title'); ?>
    | <?php echo app('translator')->get('equicare.maintenance_cost_create'); ?>
<?php $__env->stopSection(); ?>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h4 class="box-title"><?php echo app('translator')->get('equicare.maintenance_cost_create'); ?></h4>
                </div>
                <div class="box-body ">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <?php echo Form::select('hospital_id', $hospitals ?? [], null, [
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="radio iradio">
                                <label class="login-padding">
                                    <?php echo Form::radio('type', 'amc', false, ['class' => $errors->has('type') ? 'is-invalid' : '','checked']); ?> <?php echo app('translator')->get('equicare.annual_cost'); ?>
                                </label>
                                <label>
                                    <?php echo Form::radio('type', 'cmc', false, ['class' => $errors->has('type') ? 'is-invalid' : '']); ?> <?php echo app('translator')->get('equicare.comprehensive_cost'); ?>
                                </label>
                                <br />
                        ...
                        <div class="form-group col-md-3">
                            <label css="margintpop"><?php echo app('translator')->get('equicare.cost_by'); ?>:</label>
                            <div class="radio iradio zmargin">
                                <label class="login-padding">
                                    <?php echo Form::radio('cost_by', 'us',null,['checked']); ?> <?php echo app('translator')->get('equicare.own_company'); ?>
                                </label>
                                <label>
                                    <?php echo Form::radio('cost_by', 'tp', null, ['id' => 'tp']); ?> <?php echo app('translator')->get('equicare.third_party'); ?>
                                </label>
                            ...
                            <div class="row no-gutters">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="tp_name" name="tp_name"
                                        class="<?php echo e($errors->has('tp_name') ? 'is-invalid ' : ''); ?>form-control"
                                        value="<?php echo e(old('tp_name')); ?>" />
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="tp_mobile" name="tp_mobile"
                                        class="<?php echo e($errors->has('tp_mobile') ? 'is-invalid ' : ''); ?>form-control"
                                        value="<?php echo e(old('tp_mobile')); ?>" />
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" id="tp_email" name="tp_email"
                                        class="<?php echo e($errors->has('tp_email') ? 'is-invalid ' : ''); ?>form-control"
                                        value="<?php echo e(old('tp_email')); ?>" />
                    ...
                    <?php echo Form::label('equipments', __('equicare.select_equipments')); ?>
                    ...
                    <div class="add_row_equipments">
                        ...
                        <?php if(old('cost')): ?>
                            <?php $__currentLoopData = old('cost'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $input): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row no-gutters">
                                    <div class="form-group col-md-3">
                                        <?php echo Form::select('equipments[]',[], old('equipments.' . $i), [
                                    ...
                                    <div class="form-group col-md-3">
                                        <?php echo Form::text('start_dates[]', old('start_dates.' . $i), [
                                    ...
                                    <div class="form-group col-md-3">
                                        <?php echo Form::text('end_dates[]', old('end_dates.' . $i), [
                                    ...
                                    <div class="form-group col-md-3">
                                        <?php echo Form::number('cost[]', old('cost.' . $i), [
                        ...
                        <?php else: ?>
                            <div class="row no-gutters">
                                <div class="form-group col-md-3">
                                    <?php echo Form::select('equipments[]', [], null, [
                                ...
                                <div class="form-group col-md-3">
                                    <?php echo Form::text('start_dates[]', null, [
                                ...
                                <div class="form-group col-md-3">
                                    <?php echo Form::text('end_dates[]', null, [
                                ...
                                <div class="form-group col-md-3">
                                    <?php echo Form::number('cost[]', null, ['class' => 'form-control', 'placeholder' => __('equicare.enter_cost'),'required'=>'required']); ?>
                    ...
                    <div class="col-md-12" id="fa-fa-plus-id">
                        <button type="button" class="pull-right btn btn-primary btn-sm add_btn btn-flat leftmargin"><i
                                class="fa fa-plus" id="fa-fa-plus-id"></i> <?php echo app('translator')->get('equicare.add_more_equipments'); ?></button>
                        <button type="button"
                            class="pull-right btn btn-danger btn-sm delete_row_btn btn-flat none-display"><i
                                class="fa fa-close"></i> <?php echo app('translator')->get('equicare.delete_line'); ?></button>
                    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    function equipment_old_select(){
        ...
        var oldEquipments = <?php echo json_encode(old('equipments')); ?>;
        ...
        $(document).ready(function() {
            ...
            $('.add_btn').on('click', function(e) {
                ...
                $(this).parent().siblings('.add_row_equipments').append(
                    ...
                    '" class="form-control start_dates" placeholder="<?php echo e(__('equicare.enter_start_date')); ?>" autocomplete="off" required>	' +
                    '</div>  ' +
                    '<div class="form-group col-md-3">  ' +
                    ' <input type="text" name="end_dates[]" id="end_dates' + $i +
                    '" class="form-control end_dates" placeholder="<?php echo e(__('equicare.enter_end_date')); ?>" autocomplete="off" required>	' +
                    ' </div>  ' +
                    ' <div class="form-group col-md-3">  ' +
            ...
            $('select[name=hospital_id]').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (<?php echo json_encode(old('equipments')); ?> !== null) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\equicare - main\framework\resources\views/maintenance_cost/create.blade.php ENDPATH**/ ?>