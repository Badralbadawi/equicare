	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h4 class="box-title"><?php echo app('translator')->get('equicare.create_calibration'); ?></h4>
			</div>
			<div class="box-body">
				<?php echo $__env->make('errors.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<?php echo Form::open(['route'=>'calibration.store', 'method'=>'POST','files'=>true]); ?>
				...
				<div class="row">
					...
					<div class="form-group col-md-4">
						...
						<?php echo Form::select('unique_id',$unique_ids??[],null,['class'=>'form-control unique_id_select2','placeholder'=>'Select Unique Id']); ?>
					...
					<div class="form-group col-md-4">
						...
						<?php echo Form::hidden('equip_id',null,['id'=>'equip_id']); ?>
					...
					<div class="form-group col-md-4">
						<?php echo Form::label('date_of_calibration',__('equicare.calibration_date')); ?>

						<?php echo Form::text('date_of_calibration',null,['class' => 'date_of_calibration form-control']); ?>

					</div>
					<div class="form-group col-md-4">
						<?php echo Form::label('due_date',__('equicare.due_date')); ?>

						<?php echo Form::text('due_date',null,['class' => 'due_date form-control']); ?>
					...
					<div class="form-group col-md-4">
						<?php echo Form::label('company_this',__('equicare.company')); ?>

						<?php echo Form::text('company_this',null,['class' => 'form-control']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\equicare - main\framework\resources\views/calibrations/create.blade.php ENDPATH**/ ?>