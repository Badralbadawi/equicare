...
<li class="breadcrumb-item active"><?php echo app('translator')->get('equicare.edit'); ?></li>
<?php $__env->stopSection(); ?>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box-header">
				<h4 class="box-title"><?php echo app('translator')->get('equicare.edit_role'); ?></h4>
				</div>
				<div class="box-body ">
					<?php echo $__env->make('errors.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					<form class="form" method="post" action="<?php echo e(route('roles.update' , $role->id)); ?>">
						...
						<div class="form-group col-md-6">
							...
							<input type="text" name="name" value="<?php echo e($role->name); ?>" class="form-control"/>
                               ...
                               <?php echo $__env->make('user_role_permission.table_edit_role',['data'=>$role], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            		<?php endif; ?>  
							</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\equicare - main\framework\resources\views/roles/edit.blade.php ENDPATH**/ ?>