		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						<?php echo Form::label('maintenance_cost_create',__('equicare.maintenance_cost_create')); ?>

						<?php echo Form::text('maintenance_cost_create', null, ['class'=>'form-control maintenance_cost_create']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\equicare - mains\framework\resources\views/call_breakdowns/index.blade.php ENDPATH**/ ?>